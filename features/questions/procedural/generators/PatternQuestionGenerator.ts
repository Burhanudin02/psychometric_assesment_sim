...
export class PatternQuestionGenerator implements IProceduralQuestionGenerator {
  readonly domain = "ABSTRACT_REASONING";
  readonly questionType = QuestionType.SVG_PATTERN;
  readonly subtopics = ["rotation_pattern"] as const;
  ...
  generate(_seed?: number): QuestionItem {
    ...
    return {
      ...
      difficulty: "EASY",
      prompt:
        "Perhatikan perputaran jarum penunjuk biru pada diagram. Tentukan arah jarum penunjuk pada langkah ke-4:",
      svgData: svg,
      options: [
      ...
      correctAnswer: "A",
      explanation:
        "Jarum penunjuk berputar konstan 90 derajat searah jarum jam (Utara -> Timur -> Selatan -> Barat).",
