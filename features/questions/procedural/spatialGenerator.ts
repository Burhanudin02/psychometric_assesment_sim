...
export function generateProceduralSpatial(): QuestionItem {
  ...
  return {
    ...
    difficulty: "MODERATE",
    prompt: "Sebuah kubus memiliki simbol ▲ di sisi atas, ■ di sisi kiri depan, dan ● di sisi kanan depan. Jika kubus diputar 90 derajat searah jarum jam terhadap sumbu vertikalnya, simbol apa yang sekarang berada di sisi kanan depan?",
    svgData: svg,
    options: [
    ...
    correctAnswer: "A",
    explanation: "Ketika kubus diputar 90 derajat searah jarum jam dilihat dari atas, sisi kiri depan (■) berpindah ke posisi kanan depan yang baru, sedangkan sisi yang sebelumnya di belakang kanan berputar ke sisi samping.",
